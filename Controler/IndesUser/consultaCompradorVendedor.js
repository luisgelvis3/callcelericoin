            ...
            console.log(err);
                ...
                if(result[0].id_intercambio != null && result[0].id_intercambio != ""){
                    ...
                    var query = connection.query(
                        ...
                        "CONVERT(AES_DECRYPT(con.contrasena_1, UNHEX(SHA2('bc12jD=U\d7MrPr',512))), char(100)) as contrasena_1, "+
                        "CONVERT(AES_DECRYPT(con.contrasena_2, UNHEX(SHA2('bc12jD=U\d7MrPr',512))), char(100)) as contrasena_2, "+
                        ...
                        if (err) {
                            console.log(err);
                                ...
                                if(result[0].id_anuncio != null && result[0].id_anuncio != ""){
                                    ...
                                    datosFormulario[4] = result[0].contrasena1;
                                    datosFormulario[5] = result[0].contrasena2;
